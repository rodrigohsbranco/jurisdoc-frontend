...
declare const _default: {
    ...
    locale: {
        isRtl: globalThis.Ref<boolean>;
        rtl: globalThis.Ref<Record<string, boolean>>;
        rtlClasses: globalThis.Ref<string>;
        name: string;
        decimalSeparator: import("vue").ShallowRef<string>;
        messages: globalThis.Ref<import("vuetify").LocaleMessages>;
        current: globalThis.Ref<string>;
        fallback: globalThis.Ref<string>;
